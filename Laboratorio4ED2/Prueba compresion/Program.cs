...
namespace Prueba_compresion
{
    public class Program
    {
        static void Main(string[] args)
        {
           ...
           /* lZW.Comprimir("WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*" +
                "WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*WaaaaabaaaaaWaaaaabaaaaa*");*/
